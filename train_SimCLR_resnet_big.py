...
parser.add_argument('--batch_size', type = int, default = 1, help = 'The training batch size')
parser.add_argument('--epochs', type = int, default = 500, help = 'The number of training epochs')
parser.add_argument('--checkpoint_directory', type = str, default = 'checkpoints_market1501_SimCLR', help = 'The path to store the model checkpoints')
...
writer = SummaryWriter('logs_market1501_SimCLR')
...
train_dataset = torchvision.datasets.ImageFolder(root = args.dataset_path, transform = TwoCropImageTransform())
